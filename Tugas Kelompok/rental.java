...
public class rental{
    public static void main(String[] args) {
        informasiKendaraan halo[] = new informasiKendaraan[]{
            new Avanza("B 1120 BA", "Avanza", 2016, "Putih", 10),
            new Beat("D 2043 LA", "Honda", 2007, "Hotam", 5)
        };

        for(informasiKendaraan k : halo){
            k.printData();
            System.out.println("--------------------------------");
        }
